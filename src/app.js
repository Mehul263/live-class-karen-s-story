...
function moreAboutKaren(parents, noOfSiblings, isNuclearFamily){
            var parents = typeof(parents);
            var noOfSiblings = typeof(noOfSiblings);
            var isNuclearFamily = typeof(isNuclearFamily);
            if (parents=="string" && noOfSiblings=="number" && isNuclearFamily=="boolean") {
                return true;
            }
            else {
                return false;
